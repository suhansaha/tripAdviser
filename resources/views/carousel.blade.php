...
<div id="myCarousel" class="content-section carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img class="first-slide" src="{!! asset('images/oktoberfest.jpg') !!}" alt="First slide">
            <div class="container">
     ...
     <!--               <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>-->
        ...
        <div class="item">
            <img class="second-slide" src="{!! asset('images/Ganesh-Chathurthi-2014.jpg') !!}" alt="Second slide">
            <div class="container">
                <div class="carousel-caption">
